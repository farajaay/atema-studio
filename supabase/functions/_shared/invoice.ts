// ATEMA STUDIO — Invoice HTML generator (Deno/Edge mirror).
//
// MIRROR of src/services/invoice.ts — pure HTML generation only.
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  @media print{.invoice{box-shadow:none;border-radius:0}body{background:white;padding:0}}
</style>
</head>
<body>
<div class="invoice">
