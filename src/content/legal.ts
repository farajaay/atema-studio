...
// so a copy change updates both surfaces.
...
<h3 style="font-family:'Cormorant Garamond',serif;font-size:1.05rem;color:#8C6B4F;margin:0 0 14px">Payment terms</h3>
<ul style="padding-left:18px;margin:0 0 16px;font-size:0.82rem;line-height:1.9;color:#4A3728">
...
<h3 style="font-family:'Cormorant Garamond',serif;font-size:1.05rem;color:#8C6B4F;margin:0 0 14px">Cancellation & rescheduling</h3>
<div style="background:#fff8f0;border-left:3px solid #8C6B4F;padding:10px 14px;border-radius:6px 0 0 6px;font-size:0.82rem;color:#5c3d1e;font-weight:600;margin:0 0 12px">
...
<h3 style="font-family:'Cormorant Garamond',serif;font-size:1.05rem;color:#8C6B4F;margin:0 0 14px">Delivery</h3>
<ul style="padding-left:18px;margin:0 0 16px;font-size:0.82rem;line-height:1.9;color:#4A3728">
...
<h3 style="font-family:'Cormorant Garamond',serif;font-size:1.05rem;color:#8C6B4F;margin:0 0 14px">Intellectual property</h3>
<ul style="padding-left:18px;margin:0 0 8px;font-size:0.82rem;line-height:1.9;color:#4A3728">
...
<h3 style="font-family:'Cormorant Garamond',serif;font-size:1.05rem;color:#8C6B4F;margin:0 0 14px">Personal Data Protection Policy (PDPL)</h3>
<p style="font-size:0.82rem;line-height:1.9;color:#4A3728;margin:0 0 14px">
